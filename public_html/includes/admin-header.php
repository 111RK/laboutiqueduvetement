...
<div class="flex">
    <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 w-64 bg-white shadow-lg z-40 transform -translate-x-full lg:translate-x-0 transition-transform">
        ...
        <nav class="p-4 space-y-1">
            ...
            <a href="attributes.php" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium <?= $current_page === 'attributes.php' ? 'bg-primary-50 text-primary-700' : 'text-gray-600 hover:bg-gray-50' ?>">
