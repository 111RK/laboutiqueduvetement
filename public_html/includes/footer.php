...
<div id="cart-drawer" style="position:fixed;top:0;right:0;bottom:0;width:100%;max-width:380px;transform:translateX(100%);transition:transform 0.3s ease;z-index:60;pointer-events:none;">
    <div style="height:100%;display:flex;flex-direction:column;background:#fff;box-shadow:-4px 0 24px rgba(0,0,0,0.12);pointer-events:auto;">
        ...
        <div id="cart-footer" class="border-t p-4 pb-20 sm:pb-4 hidden">
